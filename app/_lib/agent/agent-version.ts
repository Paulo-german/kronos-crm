...
export const AGENT_VERSION_ALIAS: Record<
  string,
  'single-v1' | 'single-v2' | 'crew-v1' | 'engine-v1'
> = {
  // legacy
  v1: 'single-v1',
  v2: 'single-v2',
  ...
  'single-v2': 'single-v2',
  'crew-v1': 'crew-v1',
  // engine-v1: nova versão (motor reconstruído) — sem alias legado
  'engine-v1': 'engine-v1',
}

export function resolveCanonicalAgentVersion(
