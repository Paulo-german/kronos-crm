...
export const PLANS: PlanInfo[] = [
  ...
  },
  {
    id: 'scale',
    name: 'Scale',
    description: 'O Motor — para equipes em crescimento que querem saber exatamente onde agir.',
    price: 697,
  ...
  },
  {
    id: 'enterprise',
    name: 'Enterprise',
    description: 'A Nave — para grandes operações com inteligência e recursos avançados.',
    price: 1197,
...
export const COMPARISON_DATA: ComparisonRow[] = [
  ...
  {
    feature: 'Score de saúde da carteira',
    light: false,
    essential: false,
    scale: true,
    enterprise: true,
