...
import { removeEvolutionGoCredentialsSchema } from './schema'

export const removeEvolutionGoCredentials = orgActionClient
  .schema(removeEvolutionGoCredentialsSchema)
  .action(async ({ parsedInput: { inboxId }, ctx }) => {
    ...
    // 3. Limpar credenciais — NÃO tocar na instância do servidor Go
