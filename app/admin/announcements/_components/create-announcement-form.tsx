          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <RadioGroup
                ...
                className="space-y-2"
              >
                <div className="flex items-center gap-3 rounded-xl border border-border p-3 transition-colors hover:bg-muted/40">
                ...
                <div className="flex items-start gap-3 rounded-xl border border-border p-3 transition-colors hover:bg-muted/40">
            ...
            <div className="overflow-hidden rounded-xl border border-border bg-card">
              <div className="p-3.5">
                <div className="flex items-start gap-3">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-kronos-purple/10">
                    <Megaphone className="h-4 w-4 text-kronos-purple" />
                  </div>
                  <div className="min-w-0 flex-1">
              ...
              <div className="flex items-center justify-between border-t border-border/50 px-3.5 py-2.5 text-xs text-muted-foreground">
