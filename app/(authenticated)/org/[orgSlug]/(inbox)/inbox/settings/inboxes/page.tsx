...
import { InboxesCardGrid } from '@/(authenticated)/org/[orgSlug]/(inbox)/inbox/settings/inboxes/_components/inboxes-card-grid'
import DiscoverInstancesButton from '@/(authenticated)/org/[orgSlug]/(inbox)/inbox/settings/inboxes/_components/discover-instances-button'
import CreateInboxButton from '@/(authenticated)/org/[orgSlug]/(inbox)/inbox/settings/inboxes/_components/create-inbox-button'
