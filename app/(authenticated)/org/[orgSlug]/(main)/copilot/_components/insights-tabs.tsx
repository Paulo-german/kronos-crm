  ...
  return (
    <Tabs defaultValue="at-risk" className="flex-1">
      <TabsList className="grid h-12 w-full grid-cols-4 rounded-md border border-border/50 bg-tab/30">
        <TabsTrigger value="at-risk" className="rounded-md py-2 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm">
        ...
        <TabsTrigger value="stalled" className="rounded-md py-2 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm">
          <span className="flex items-center gap-1.5">
            Pipeline estagnado
        ...
        <TabsTrigger value="reactivation" className="rounded-md py-2 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm">
          <span className="flex items-center gap-1.5">
            Reativação
            <Badge variant="secondary" className="h-4 px-1.5 text-[10px]">
        ...
        <TabsTrigger value="automations" className="rounded-md py-2 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm">
          Automações
        </TabsTrigger>
      </TabsList>
