              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    ...
                    className={cn(
                      ...
                      !localFilters.createdAtFrom && 'text-muted-foreground',
                    )}
                  >
                    <CalendarIcon className="mr-2 h-4 w-4" />
                    {localFilters.createdAtFrom ? (
                      format(localFilters.createdAtFrom, 'PPP', { locale: ptBR })
                    ) : (
                    ...
                    {localFilters.createdAtFrom && (
                      <X
                        ...
                        onClick={(event) => {
                          ...
                          setLocalFilters({ ...localFilters, createdAtFrom: null })
                        }}
                      />
                    )}
                  </Button>
                ...
                <PopoverContent className="w-auto p-0" align="start">
                  <Calendar
                    ...
                    onSelect={(date) =>
                      setLocalFilters({ ...localFilters, createdAtFrom: date ?? null })
                    }
                  />
                </PopoverContent>
              </Popover>
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    ...
                    className={cn(
                      'w-full justify-start text-left font-normal',
                      !localFilters.createdAtTo && 'text-muted-foreground',
                    )}
                  >
                    <CalendarIcon className="mr-2 h-4 w-4" />
                    {localFilters.createdAtTo ? (
                      format(localFilters.createdAtTo, 'PPP', { locale: ptBR })
                    ) : (
                    ...
                    {localFilters.createdAtTo && (
                      <X
                        ...
                        onClick={(event) => {
                          event.stopPropagation()
                          setLocalFilters({ ...localFilters, createdAtTo: null })
                        }}
                      />
                    )}
                  </Button>
                ...
                <PopoverContent className="w-auto p-0" align="start">
                  <Calendar
                    ...
                    onSelect={(date) =>
                      setLocalFilters({ ...localFilters, createdAtTo: date ?? null })
                    }
                  />
                </PopoverContent>
              </Popover>
