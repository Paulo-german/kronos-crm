...
import DeleteProductDialogContent from '@/(authenticated)/products/_components/delete-dialog-content'
import UpsertProductDialogContent from '@/(authenticated)/products/_components/upsert-dialog-content'
