...
interface AppointmentsCalendarWeekPageProps {
  params: Promise<{ orgSlug: string }>
}

const AppointmentsCalendarWeekPage = async ({
  params,
}: AppointmentsCalendarWeekPageProps) => {
...
export default AppointmentsCalendarWeekPage
