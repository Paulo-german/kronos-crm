...
const AgentDetailPage = async ({ params }: AgentDetailPageProps) => {
  ...
  const [agent, pipelines, inboxes, followUps, followUpQuota, services, completedTutorialIds] =
    await Promise.all([
  ...
  const inboxConnectionData: Record<
    string,
    {
      stats: Awaited<ReturnType<typeof getAgentConnectionStats>> | null
      info: Awaited<ReturnType<typeof getEvolutionInstanceInfo>> | null
    }
  > = {}
