...
export async function buildTestSystemPrompt(
  ...
  criticalRules.push(
    ...
    '- Quando faltar apenas uma informação pontual (endereço, preço, política), use `hand_off_to_human` com `mode: "notify"` — a IA continua atendendo e o responsável é notificado.',
